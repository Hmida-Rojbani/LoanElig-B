...
import de.tekup.loan.endpoint.LoanEndpoint;
...
public class LoanConfig {
	...
	public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema schema) {
		...
		defaultWsdl11Definition.setTargetNamespace(LoanEndpoint.NAME_SPACE);
		defaultWsdl11Definition.setPortTypeName("LoanServiceIndicator");
